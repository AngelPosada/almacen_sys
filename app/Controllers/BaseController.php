...
abstract class BaseController
{
    ...
    protected function render(
        ...
        // $config siempre disponible en vistas y layouts
        $config = $GLOBALS['app_config'] ?? require ROOT_PATH . '/config/config.php';
        $data['config'] = $config;

        // Extraer $data como variables locales
        ...
        // $config está en scope porque fue declarada arriba en este método
        ob_start();
        require $viewFile;
        $content = ob_get_clean();

        // $config sigue disponible para el layout en este mismo scope
